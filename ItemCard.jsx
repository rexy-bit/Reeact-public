    ...
    return(
        <div className="flex flex-col content-center p-5 shadow-2xl rounded-xl transition-transform duration-200 hover:scale-105 bg-white w-[250px]">
            ...
            <div className="flex flex-col gap-1">
                <Link to="/description"><p className="leading-5 font-[600]">{item.nom}</p></Link>
                <StarsRating
                 note={item.note}
                />
            ...
            <button className="h-[40px] bg-blue-950 text-white font-bold rounded-lg cursor-pointer transition-opacity duration-200 hover:opacity-80 active:opacity-60 mt-9">Add to Cart</button>
        </div>
    )
}